...
extension AppDelegate {
    internal func onSignInWasApproved(user: FIRUser) {
    ...
    internal func onSignInApproved(user: GIDGoogleUser) {
...
extension AppDelegate {
    ...
    fileprivate func navigateToInitialScreen() {
